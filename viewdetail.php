...
while($res = mysqli_fetch_array($query)){
    ...
    <tr>
        ...
        <td><a href="addbill.php?id=<?php echo  $res['id']; ?>&fullname=<?php echo  $res['fullname']; ?>&address=<?php echo  $res['address']; ?>&cont=<?php echo  $res['contact']; ?>&em=<?php echo  $res['email']; ?>&pa=<?php echo  $res['password']; ?>" data-toggle="tooltip" data-placement="top" title="Print"><i class="fa fa-add"></i></a></td>
